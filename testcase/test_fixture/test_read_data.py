...
@pytest.mark.parametrize("Mbcx_data", get_yaml['Mbcx_data'])
...
@pytest.mark.parametrize("FBcx_data", get_yaml['FBcx_data'])
...
@pytest.mark.parametrize("addMBerr_data", get_yaml['addMBerr_data'])
