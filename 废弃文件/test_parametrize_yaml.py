...
from 废弃文件.read_data import get_data
...
@pytest.mark.parametrize('id', get_data(file_path="/config/data.yaml")['id'])
@pytest.mark.p0
def test_Mbcx(id):
...
@pytest.mark.parametrize('data1', get_data(file_path="/config/data.yaml")['data1'])
@pytest.mark.p1
def test_FBcx(data1):
